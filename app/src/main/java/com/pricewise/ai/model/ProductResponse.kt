...
data class ChronosForecastData(
    ...
    @SerializedName("forecastSource") val forecastSource: String? = null,
    @SerializedName("isAiPrediction") val isAiPrediction: Boolean? = null,
    @SerializedName("fallbackUsed") val fallbackUsed: Boolean? = null,
    @SerializedName("fallbackReason") val fallbackReason: String? = null,
